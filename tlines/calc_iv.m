function i = calc_iv(tl,zobs,iobs,zsrc,jsrc)
% i = calc_iv(tl,zobs,iobs,zsrc,jsrc)
%
% Part of the tlines calculator (see calc_tlines), given the unit
% series voltage source at an arbitrary point, calculate the current
% at an another point.
...
if iobs<jsrc,
	...
	i = calc_iv(tl,zsrc,jsrc,zobs,iobs);
else
	n = iobs;
