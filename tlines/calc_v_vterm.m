function v = calc_v_vterm(tl,zobs,iobs)
% v = calc_v_vterm(tl,zobs,iobs)
%
% Part of the tlines calculator (see calc_tlines), given unit voltage
% at the right terminal of a tline calculate voltage at an arbitrary
% point of this tline.
